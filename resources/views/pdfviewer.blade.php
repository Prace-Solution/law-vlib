...
-->  --}}
<html dir="ltr" mozdisallowselectionprint moznomarginboxes onbeforecopy="return false"
...
<body onmousedown="rightclick();" oncontextmenu="window.event.preventDefault();window.event.stopPropagation(); return false;" tabindex="1" class="loadingInProgress">
   <div style='color: white; font-size: 14pt;margin-bottom: 8px;margin-top: 8px; padding: 16px; text-align: center'> Designed &amp; Developed by <a  style="color:#07bcbcbc" href='https://wwww.crust.media.com' target='_'><span>Crust</span></a></div>
        ...
        <div id="mainContainer">
            ...
            <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
              ...
              <span data-l10n-id="presentation_mode_label">Presentation Mode</span>
                    ...
                    <button hidden="true" id="secondaryOpenFile" class="secondaryToolbarButton openFile visibleLargeView" title="Open File" tabindex="52" data-l10n-id="open_file">
              <span data-l10n-id="open_file_label">Open</span>
            </button>

            <button style="display:none !important;" id="secondaryPrint" class="secondaryToolbarButton print visibleMediumView" title="Print" tabindex="53" data-l10n-id="print">
              <span data-l10n-id="print_label">Print</span>
            </button>

              <button style="display:none !important;" hidden="true" id="secondaryDownload" class="secondaryToolbarButton download visibleMediumView" title="Download" tabindex="54" data-l10n-id="download">
            ...
            <div class="toolbar">
               ...
               <button id="print" style="display:none !important;" class="toolbarButton print hiddenMediumView" title="Print" tabindex="33" data-l10n-id="print" hidden="true">
                  <span data-l10n-id="print_label">Print</span>
                </button>

                 <button id="download" style="display:none !important;" class="toolbarButton download hiddenMediumView" title="Download" tabindex="34" data-l10n-id="download" hidden="true">
                  <span data-l10n-id="download_label">Download</span>
                </button>
	...
	<script src="{{ asset('custom/js/control-83.js') }}"></script>
    <script src="{{ asset('js/macKeys.js') }}"></script>
	<script src="{{ asset('js/cmds.js') }}"></script>
