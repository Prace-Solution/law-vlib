...
@section('side-bar-nav')
  <li ><a href="{{ route('lecturer.home.nav','dashboard-view') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
    ...
    <li class="treeview active">
        ...
        <ul class="treeview-menu">
            <li><a href="{{ route('lecturer.home.nav','course-material-upload-ui') }}"><i class="fa fa-book text-green"></i> course</a></li>
            <li class="active"><a href="{{ route('lecturer.home.nav','course-resource-material-upload-ui') }}"><i class="fa fa-book text-aqua"></i> reading</a></li>
        </ul>
    </li>
    <li class="treeview">
        <a href="#">
...
@section('breadcrumb')
    <h1>
        Resource
        <small>(upload a reading resource)</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Reading Resource Material Upload</div>
                    <div class="panel-body">
                       ...
                       {{--  method="POST" enctype="multipart/form-data"  action="" --}}
                        <form class="form-horizontal main" role="form">
                            {{ csrf_field() }}
                            <input name='kind' type='hidden' value='2' hidden>
                            <br><br>
                            ...
                            <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <TextArea id="description" class="form-control" name="description"   placeholder ="Enter the material description here"  required autofocus>{{ old('description') }}</TextArea>
                            ...
                            <div class="form-group {{ $errors->has('uploadable') ? ' has-error' : '' }}">
                              ...
                              <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    <button id='add-course-resource-btn' type="submit" class="btn btn-primary btn-lg pull-right">
                                      Submit
                                    </button>
...
<script>
   ($("#add-course-resource-btn")).on("click", function(event) {
        ...
        if(f.checkValidity())
        {
            ...
            var url = "../resource-material/upload";
