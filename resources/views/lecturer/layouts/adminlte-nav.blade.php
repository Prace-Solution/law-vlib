  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>@yield('logo-shortcut')</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>@yield('logo-fullname')</b></span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="{{ route('lecturer.logout') }}" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
          <!-- Control Sidebar Toggle Button -->
          <!-- Control Sidebar Toggle Button for user settings and recent activity -->
          {{--  <li>
