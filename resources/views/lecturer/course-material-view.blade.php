  ...
  <li ><a href="{{ route('lecturer.home.nav','dashboard-view') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            {{--  <li > <a href="{{ route('lecturer.home.nav','course-add-ui') }}"><i class="fa fa-plus text-green"></i> add</a></li>  --}}
    ...
    <li class="treeview active">
        ...
        <ul class="treeview-menu">
            <li class="active"> <a href="{{ route('lecturer.home.nav','course-material-view') }}"><i class="fa fa-book text-green"></i> course</a></li>
