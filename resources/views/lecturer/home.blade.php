...
@section('level')
    {{--  @if(Auth::guard('lecturer')->user())
        <small>{{ Auth::guard('lecturer')->user()->level['name'] }} </small>
    @endif   --}}
@endsection

@section('side-bar-nav')
  <li class="active"><a href="{{ route('lecturer.home.nav','dashboard-view') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
    <li class="treeview">
        <a href="#">
