...
@section('side-bar-nav')
    <li class="active"><a href="{{ route('student.home.nav','dashboard-view') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
    <li class="treeview">
        <a href="#">
        ...
        <ul class="treeview-menu">
            <li class=""> <a href="{{ route('student.home.nav','course-resource-view') }}"><i class="fa fa-circle-o text-red"></i> Course</a></li>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="index.html#revenue-chart" data-toggle="tab">Area</a></li>
              <li><a href="index.html#sales-chart" data-toggle="tab">Donut</a></li>
              ...
              <div class="pull-right box-tools">
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu pull-right" role="menu">
                    <li><a href="index.html#">Add new event</a></li>
                    <li><a href="index.html#">Clear events</a></li>
                    <li class="divider"></li>
                    <li><a href="index.html#">View calendar</a></li>
                  </ul>
                </div>
