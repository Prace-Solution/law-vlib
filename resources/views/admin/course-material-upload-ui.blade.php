...
@section('side-bar-nav')
    ...
    <li class="treeview ">
        ...
        <ul class="treeview-menu">
            ...
            <li class=''><a href="{{ route('admin.home.nav','course-view') }}"><i class="fa fa-eye text-yellow"></i> view</a></li>
        </ul>
    </li>
    <li class="treeview active">
        ...
        <ul class="treeview-menu">
            <li class='active'> <a href="{{ route('admin.home.nav','course-material-upload-ui') }}"><i class="fa fa-book text-green"></i> course</a></li>
