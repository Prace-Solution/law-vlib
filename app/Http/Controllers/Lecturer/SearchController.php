            ...
            if (! empty($courses))
            {
                ...
                foreach ($courses as $key =>  $course) 
                {
                    ...
                    $output .= '<tr>' .
                        ...
                        '<td id="{{ $course->id }}"><a  class="active" ui-toggle-class=""><i class="fa fa-check text-success text-active"></i></a><a><i class="fa fa-times text-danger text"></i></a></td>' .
        ...
        if ($request->ajax())
        {
            ...
            if (!empty($materials)){
                ...
                foreach ($materials as $key => $material) {
                    ...
                    '<td id="' . $material->id . '"><a href="' . route("lecturer.read") . '?file=' . $material->local_path  . '" class="active" ui-toggle-class=""><i class="fa fa-eye text-success text-active"></i></a>
                  
                    </td>' ;
                   // '<td id="' . $material->id . '"><a href="'.url('pdfviewer/web/viewer.html?file=' .$material->local_path ) . '" class="active" ui-toggle-class=""><i class="fa fa-check text-success text-active"></i></a>
            ...
            if (!empty($resources)){
                ...
                foreach ($resources as $key => $resource) {
                   ...
                   // '<td> <span class="text-ellipsis">' . $resource->url . '</span> </td>'.
                    ...
                    '<td id="' . $resource->id . '"><a href="' . route("lecturer.read") . '?file=' . $resource->local_path  . '" class="active" ui-toggle-class=""><i class="fa fa-eye text-success text-active"></i></a>
                    </td>' ;
                    //'<td id="' . $resource->id . '"><a href="'.url('pdfviewer/web/viewer.html?file=' . $resource->local_path ) . '" class="active" ui-toggle-class=""><i class="fa fa-check text-success text-active"></i></a>
                   // <a><i class="fa fa-times text-danger text"></i></a>
                    //</td>' ;
            ...
            if (!empty($departments)) 
            {
                ...
                foreach ($departments as $key => $department) {
                    ...
                    $output .= '<tr>' .
                        ...
                        '<td id="' . $department->id . '"><a  class="active" ui-toggle-class=""><i class="fa fa-check text-success text-active"></i></a> <a><i class="fa fa-times text-danger text"></i></a></td>';
